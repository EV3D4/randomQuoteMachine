...
function caseInSwitch(val) {
 ...
 switch (val) {
   case 0:
     ...
     break;
   case 1:
     caseString = "The age of adventures is over. Even if we reach the seventh galaxy, we will go there helmeted and mechanized, and it will not change a thing for us; we will find ourselves exactly as we are now: helpless children in the face of death, living beings who are not too sure how they live, why they are alive, or where they are going. <br><br> -Sri Aurobindo";
     break;
   case 2:
